...
Rails.application.config.assets.precompile += %w(https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700)
...
Rails.application.config.assets.precompile += %w(https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js)
